...
import axios from 'axios';
 ...
 export default class Archive extends React.Component{
    ...
    get = () => {
        ...
        axios.get('http://182.184.66.211:8080/~saad/mpset/public/api/v1/en/user/event/history', {
            'headers': {
                                ...
                                <Card key={item.id} style={{ marginBottom: 20 }}>
                                    ...
                                    <TouchableOpacity
                                        ...
                                        <View style={{ flexDirection: 'row', marginTop: 5 }}>
                                            ...
                                            <View >
                                                <Text style={{ marginLeft: 10, fontSize: 13 }}>{item.status}</Text>
                                            </View>
                                        </View>
                                        <View style={{ flexDirection: 'row', marginTop: 5 }}>
                                            <View>
                                            ...
                                            <View >
                                                <Text style={{ marginLeft: 10, fontSize: 13 }}>{item.PlayerStatus}</Text>
                                            </View>
                                        </View>
                                        <View style={{ flexDirection: 'row', marginTop: 5 }}>
